...
public class HidePictureFrameButton : MonoBehaviour
{
    [SerializeField]
    ...
    public void HidePictureFrame()
    {
        m_PictureFrame.gameObject.SetActive(false);
    }
    ...
    private void OnPictureFrameVisibilityChanged(bool value)
    {
        if (value)
        {
            m_RectTransform.DOAnchorPosY(-25.0f, 1).SetEase(Ease.OutBounce);
        }
        else
        {
